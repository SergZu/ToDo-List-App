...
const TaskListTitle = function({ 
    ...
    const listTitleClass = addTaskMode ? 
                                          'TaskListTitle open' : 
                                          'TaskListTitle';
    const restLayout = addTaskMode ? 
                                    (<TaskAddForm 
                                                    nextId={nextId} 
                                                    addTask={addTask} 
                                    ...
                                    (<>
                                            <input 
                                                    className='TaskListTitle-search' 
                                                    type='text' 
                                                    value={searchQuery}
                                                    onChange={onSearchChangeHandler} 
                                                    placeholder={`Find in ${filterName}`} 
                                            />
                                            <button 
                                                    className='TaskListTitle-add' 
                                                    onClick={onAddTaskClickHandler} 
                                                    onKeyPress={onAddTaskKeyPressedHandler}
                                            >
                                                Add Task
                                            </button>
                                    </>); 
    ...
    return (
        <div className={listTitleClass}>
           <h3 className='TaskListTitle-name'>
               {filterName}
            </h3>
